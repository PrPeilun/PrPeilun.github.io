...
[
	...
	"impressionist/adj.印象派的n.印象派艺术家",
	...
	"injection/n.注射;注射剂",
	"needle/n.针;(注射器的)针头",
	"spill(spilt,spilt)/vi.溢出;酒落vt.使溢出;使酒落",
	"male/adj.男性的;雄性的n.男人;雄性动(植)物",
	"female/adj.女性的;雌性的n.雌性的动(植)物;女人",
	"condom/n.避孕套",
	"homosexual/n.同性恋adj.同性恋的",
	"prejudice/n.偏见;成见",
	...
	"greenhouse/n.温室;花房",
	"Fahrenheit/adj.华氏的n.华氏温度计",
	"come about/发生;造成",
	"graph/n.图表;坐标图;曲线图",
	"random/adj.胡乱的;任意的",
	"phenomenon(复数-ena)/n.现象",
	"subscribe/vi.同意;捐赠;订阅vt.(签署)文件;捐助",
	...
	"alongside/adv.在旁边;沿着边prep.在……旁边;沿着……的边",
	"equipment/n.设备;装备",
	"appoint/vt.任命;委派",
	...
	"molten/adj.熔化的;熔融的",
	"fountain/vi.&vt.泉水般地喷出或涌出n.喷泉;源泉",
